...
<section class="relative pt-16 pb-32">
    <div class="container relative">
        <div class="grid items-center grid-cols-1 md:grid-cols-12">
            <div class="text-center lg:col-span-8 md:col-span-6 md:text-start">
                <h3 class="text-2xl font-semibold leading-normal">Semua Produk</h3>
            </div>
            ...
            <div class="hidden lg:col-span-4 md:col-span-6 md:text-end md:block">
                <a href="{{ route('customer.product.index') }}"
                    ...
                    Semua <i class="align-middle uil uil-arrow-right"></i></a>
            </div>
        </div><!--end grid-->
