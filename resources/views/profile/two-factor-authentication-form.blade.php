<x-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                {{ __('Saat autentikasi dua faktor diaktifkan, Anda akan diminta untuk memasukkan token acak yang aman selama otentikasi. Anda dapat mengambil token ini dari aplikasi Google Authenticator di ponsel Anda.') }}
            </p>
        </div>
            ...
            @if ($showingQrCode)
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        @if ($showingConfirmation)
                            {{ __('Untuk menyelesaikan pengaktifan autentikasi dua faktor, pindai kode QR berikut menggunakan aplikasi autentikator di ponsel Anda atau masukkan kunci pengaturan dan berikan kode OTP yang dihasilkan.') }}
                        @else
