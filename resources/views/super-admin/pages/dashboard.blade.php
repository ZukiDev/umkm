            ...
            <div class="p-5 flex items-center">
                ...
                <span class="ms-3">
                    ...
                    <span class="flex items-center justify-between mt-1">
                        ...
                        <span class="text-emerald-600 text-sm ms-1 font-semibold"><i class="uil uil-arrow-growth"></i>
                            3.84%</span>
                    </span>
                </span>
            </div>
            ...
            <div class="relative overflow-hidden rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900">
                ...
                <div class="p-6">
                    <ul class="list-none flex">
                        <li class="inline-block w-1/2"><span class="text-indigo-600 font-semibold">Canada</span>:<span
                    ...
                    <ul class="list-none flex">
                        <li class="inline-block w-1/2"><span class="text-indigo-600 font-semibold">Russia</span>:<span
                                class="text-slate-400 ms-2">12468</span></li>
                        <li class="inline-block w-1/2"><span
                            ...
                            <div class="flex mb-3">
                                ...
                                <div class="ms-2 max-w-lg">
                                    <p
                                        ...
                                        Hey Cristina</p>
                                    <span class="text-slate-400 text-sm"><i class="mdi mdi-clock-outline me-1"></i>59
                                        min ago</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex mb-3">
                                ...
                                <div class="me-2 max-w-lg">
                                    <p
                                        class="bg-white dark:bg-slate-900 text-slate-400 text-sm shadow dark:shadow-gray-700 px-3 py-2 rounded mb-1">
                                        Hello Calvin</p>
                                    <span class="text-slate-400 text-sm"><i class="mdi mdi-clock-outline me-1"></i>45
                                        min ago</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="inline-block">
                            <div class="flex mb-3">
                                ...
                                <div class="me-2 max-w-lg">
                                    ...
                                    <span class="text-slate-400 text-sm"><i class="mdi mdi-clock-outline me-1"></i>44
                                        min ago</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex mb-3">
                                ...
                                <div class="ms-2 max-w-lg">
                                    <p
                                        class="bg-white dark:bg-slate-900 text-slate-400 text-sm shadow dark:shadow-gray-700 px-3 py-2 rounded mb-1">
                                        Nice to meet you</p>
                                    <span class="text-slate-400 text-sm"><i class="mdi mdi-clock-outline me-1"></i>42
                                        min ago</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="inline-block">
                            <div class="flex mb-3">
                                ...
                                <div class="ms-2 max-w-lg">
                                    ...
                                    <span class="text-slate-400 text-sm"><i class="mdi mdi-clock-outline me-1"></i>40
                                        min ago</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="inline-block">
                            <div class="flex mb-3">
                                ...
                                <div class="me-2 max-w-lg">
                                    ...
                                    <span class="text-slate-400 text-sm"><i class="mdi mdi-clock-outline me-1"></i>38
                                        min ago</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex mb-3">
                                ...
                                <div class="ms-2 max-w-lg">
                                    <p
                                        ...
                                        offer</p>
                                    <span class="text-slate-400 text-sm"><i class="mdi mdi-clock-outline me-1"></i>35
                                        min ago</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="inline-block">
                            <div class="flex mb-3">
                                ...
                                <div class="me-2 max-w-lg">
                                    ...
                                    <span class="text-slate-400 text-sm"><i class="mdi mdi-clock-outline me-1"></i>29
                                        min ago</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex mb-3">
                                ...
                                <div class="ms-2 max-w-lg">
                                    <p
                                        class="bg-white dark:bg-slate-900 text-slate-400 text-sm shadow dark:shadow-gray-700 px-3 py-2 rounded mb-1">
                                        Thank you 😊</p>
                                    <span class="text-slate-400 text-sm"><i class="mdi mdi-clock-outline me-1"></i>26
                                        min ago</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex mb-3">
                                ...
                                <div class="me-2 max-w-lg">
                                    <p
                                        class="bg-white dark:bg-slate-900 text-slate-400 text-sm shadow dark:shadow-gray-700 px-3 py-2 rounded mb-1">
                                        Welcome</p>
                                    <span class="text-slate-400 text-sm"><i class="mdi mdi-clock-outline me-1"></i>15
                                        min ago</span>
                                </div>
                            </div>
                        </div>
