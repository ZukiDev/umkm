<x-action-section>
    ...
    <x-slot name="description">
        {{ __('Kelola dan log keluar dari sesi aktif Anda di browser dan perangkat lain.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Jika perlu, Anda dapat log keluar dari semua sesi browser Anda di seluruh perangkat Anda. Beberapa sesi terbaru Anda terdaftar di bawah; namun, daftar ini mungkin tidak lengkap. Jika Anda merasa akun Anda telah dikompromikan, Anda juga harus memperbarui kata sandi Anda.') }}
        </div>
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Harap masukkan kata sandi Anda untuk mengonfirmasi bahwa Anda ingin log keluar dari sesi browser Anda di seluruh perangkat Anda.') }}
