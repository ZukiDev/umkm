...
class MidtransService
{
    ...
    protected function getCustomerDetails(Order $order): array
    {
        ...
        // Misalnya, jika ada relasi dengan model User atau CustomerProfile, Anda bisa mengambil data dari sana.
        // Contoh data customer yang diambil dari order
        $customer = $order->user; // Asumsi order memiliki relasi dengan user
        if ($customer) {
            return [
        ...
        // Return default customer details or empty array if not found
        return [
            'first_name' => '',
            'email' => '',
            'phone' => '',
